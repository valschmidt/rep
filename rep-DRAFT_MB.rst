...
The calculation of depth relative to the echo-sounder from the two-way travel time measurement made along each beam has a big complicating factor, and that is that the speed of sound in water is not constant. Variations in sound speed cause acoustic signals to bend or refract as they propagate through the water column. Sound speed varies with water temperature, salinity and depth (more precisely hydrostatic pressure). This refraction must be modeled to obtain true measurements of the seafloor. 
...
..
   ...
   End:
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMDkwNzU4MTEsMTc4MTYxNzM5NSw0OD
