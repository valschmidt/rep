...
* Finally because these measurements range over many orders of magnitude, they are converted to decibels in science and engineering. Decibels are the base 10 logarithm, of the **ratio** of a measurement to a reference value. Thus any reported . The internationally agreed to reference value for underwater acoustics is 1 micro-Pascal. It is not uncommon in engineering to see measured voltages expressed in decibel form referenced to 1 Volt. Unfortunately, it is also not uncommon for decibel values to be  
...
..
   ...
   End:
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcwNTI1ODEwNCw0NzkyNjc4NTIsMTA3ND
