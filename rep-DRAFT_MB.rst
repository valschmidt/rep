...
Some sonar systems allow an operator to load a sound speed profile into the acquisition software, which they will then use to generate XYZ soundings in real-time as the data is collected. Other systems do not provide this capability, reporting only two-way travel time along each  receive beam, leaving the calculation of XYZ points (and refraction correction) to post-processing. 
...
..
   ...
   End:
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzg4MDU2ODEyLDE3ODE2MTczOTUsNDg0Nz
