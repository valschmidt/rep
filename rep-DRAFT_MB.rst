...
Time synchronization between sonar and navigation systems must be established to a high degree of accuracy to ensure artifact free data. Time errors of less than 1 ms are desirable and often can be achieved by
...
..
   ...
   End:
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE1MzUzMDk1LDEwNDYzMTkwMDIsOTMyNT
